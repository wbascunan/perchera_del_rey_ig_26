...
function renderProducts(){
  ...
  PRODUCTS.forEach(p => {
    ...
    card.innerHTML = `
      ...
      <div class="meta">${p.desc}</div>
      <div class="actions">
        <a class="btn" href="product.html?id=${encodeURIComponent(p.id)}">🎨 Personalizar</a>
        <a class="btn ghost" href="cart.html">🛒 Ver carrito</a>
      </div>
    `;
...
btnLogin?.addEventListener("click", () => {
  alert("Siguiente fase: Login real con Supabase Auth 👤✅");
});
